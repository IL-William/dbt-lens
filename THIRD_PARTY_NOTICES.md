...
| --- | --- | --- | --- |
| [CodeMirror](https://github.com/codemirror/codemirror5), including the `sql`, `yaml`, `markdown`, `jinja2` modes and the `searchcursor` and `merge` addons | 5.65.16 | MIT | Marijn Haverbeke and others |
